...
class SettingsFragment : PreferenceFragmentCompat() {
    ...
    private lateinit var experimentalFeaturesPreference: PreferenceCategory
    private lateinit var hideModePreference: TwoStatePreference
    ...
    override fun onCreatePreferences(savedInstanceState: Bundle?, rootKey: String?) {
        ...
        experimentalFeaturesPreference = findPreference("experimental_features")!!
        hideModePreference = findPreference("hide_mode")!!
        ...
        // Hide mode preference persistence (using SharedPreferences)
        val prefs = preferenceManager.sharedPreferences
        hideModePreference.isChecked = prefs?.getBoolean("hide_mode", false) ?: false
        hideModePreference.onPreferenceChangeListener =
            Preference.OnPreferenceChangeListener { _: Preference?, newValue: Any? ->
                if (newValue is Boolean) {
                    prefs?.edit()?.putBoolean("hide_mode", newValue)?.apply()
                }
                true
            }
    ...
    private fun setupLocalePreference() {
        ...
        languagePreference.entries = localizedLocales.toArray(arrayOfNulls<CharSequence>(localizedLocales.size))
