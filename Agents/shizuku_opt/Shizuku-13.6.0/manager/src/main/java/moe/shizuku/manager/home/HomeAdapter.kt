...
class HomeAdapter(private val homeModel: HomeViewModel, private val appsModel: AppsViewModel) :
    ...
    companion object {
        ...
        // NEW: Debloat and Shell cards
        private const val ID_DEBLOAT = 8L
        private const val ID_SHELL = 9L
    }
    ...
    fun updateData() {
        ...
        if (isPrimaryUser) {
            ...
            // NEW: Debloat and Shell cards placed right after status
            addItem(DebloatViewHolder.CREATOR, null, ID_DEBLOAT)
            addItem(ShellViewHolder.CREATOR, null, ID_SHELL)
